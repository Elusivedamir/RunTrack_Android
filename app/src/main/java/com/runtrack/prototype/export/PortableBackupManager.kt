...
import com.runtrack.prototype.data.RoutePointEntity
...
import com.runtrack.prototype.domain.PortableBackupCrypto
import com.runtrack.prototype.domain.GoalKind
import com.runtrack.prototype.domain.UnitSystem
import com.runtrack.prototype.domain.WorkoutStatus
import com.runtrack.prototype.settings.RunTrackSettings
...
class PortableBackupManager(
    ...
    suspend fun restoreEncrypted(bytes: ByteArray, passphrase: CharArray): Int = withContext(Dispatchers.IO) {
        ...
        data class RestoredWorkout(val workout: WorkoutEntity, val route: List<RoutePointEntity>, val heartRate: List<com.runtrack.prototype.data.HeartRateSampleEntity>)
    ...
    private fun com.runtrack.prototype.data.HeartRateSampleEntity.toJson() = JSONObject().apply {
        put("timestampMillis", timestampMillis); put("elapsedRealtimeMillis", elapsedRealtimeMillis)
        put("bpm", bpm); put("source", source)
    }

    private fun JSONObject.toHeartRateSample(workoutId: String) = com.runtrack.prototype.data.HeartRateSampleEntity(
        workoutId = workoutId,
        timestampMillis = getLong("timestampMillis"),
