...
class WorkoutTrackingService : Service() {
    ...
    private fun TrackingSnapshot.notificationText(): String = when {
        status == com.runtrack.prototype.domain.WorkoutStatus.MANUAL_PAUSED ->
            if (goalReached) "Цель достигнута · тренировка на паузе" else "Тренировка на паузе"
        status == com.runtrack.prototype.domain.WorkoutStatus.AUTO_PAUSED ->
    ...
    companion object {
        const val ACTION_START_UPDATES = "com.runtrack.prototype.action.START_LOCATION_UPDATES"
        const val ACTION_PAUSE_UPDATES = "com.runtrack.prototype.action.PAUSE_LOCATION_UPDATES"
        const val ACTION_RESUME_UPDATES = "com.runtrack.prototype.action.RESUME_LOCATION_UPDATES"
        const val ACTION_STOP_UPDATES = "com.runtrack.prototype.action.STOP_LOCATION_UPDATES"
